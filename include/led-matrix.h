...
public:
  ...
  struct Options {
    ...
    // Invert SPWM OE polarity (Active-Low vs Active-High)
    bool spwm_invert_oe;  // Flag: --led-spwm-invert-oe
...
struct RuntimeOptions {
  ...
  int opi_delay_ns;     // Nanosecond delay per GPIO access on OPi. Flag: --opi_delay_ns or --led-opi-delay-ns
